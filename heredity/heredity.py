...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # If the person has parents, calculate the probabilities based on the parents' genes
            ...
            if genes == 2:
                p_gene = p_mother * p_father
            elif genes == 1:
                p_gene = (p_mother * (1 - p_father)) + ((1 - p_mother) * p_father)
            else:
                p_gene = (1 - p_mother) * (1 - p_father)

        # Calculate the probability of having the trait
        p_trait = PROBS["trait"][genes][trait]
        # Joint probability
        p *= p_gene * p_trait
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities:
        ...
        # Update the probabilities for genes and traits
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for genes in probabilities[person]["gene"]:
            probabilities[person]["gene"][genes] /= total_gene
